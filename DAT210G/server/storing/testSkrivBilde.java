...
//		PictureDb p = new PictureDb("test", "test", 3, "2014-02-02 10:10:10", "test", "test", "test");
...
//		PictureDb pic = ReadFromDatabase.getPictureBasedOnId(2);
//		System.out.println(pic.getId() + ", " + pic.getTitle() + ", " + pic.getFileLocation());
